...
The Magento 2 Login As Customer Extension allows admins to log in as a customer without using passwords. Enter the customer account in one click and provide efficient support.
